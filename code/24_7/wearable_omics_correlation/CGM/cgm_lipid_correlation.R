...
######cgm vs lipidomics
dir.create("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_lipidomics")
setwd("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_lipidomics")
