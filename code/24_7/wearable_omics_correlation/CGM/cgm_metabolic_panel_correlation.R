...
dir.create("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolic_panel")
setwd("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolic_panel")
