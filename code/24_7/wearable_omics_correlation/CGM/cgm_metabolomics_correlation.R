...
######cgm vs metabolomics
dir.create("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolomics")
setwd("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolomics")
