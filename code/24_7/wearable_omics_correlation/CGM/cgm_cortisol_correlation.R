...
######cgm vs cortisol
###work directory
###data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_cortisol
####which time window
temp_data = 
...
load(here::here("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_cortisol/integrated_info"))
...
# knitr::spin(
#   hair = here::here(
#     "R/24_7_mike/wearable_omics_correlation/CGM/cgm_cortisol_correlation.R"
#   ),
#   knit = FALSE
# )
# 
# file.copy(from = here::here("R/24_7_mike/wearable_omics_correlation/CGM/cgm_cortisol_correlation.Rmd"),
