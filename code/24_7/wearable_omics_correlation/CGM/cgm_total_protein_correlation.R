...
dir.create("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_total_protein")
setwd("data/7_24_mike/wearable_omics_correlation/cgm_omics_correlation/cgm_total_protein")
