...
###so we will get the correlation plot between them
{
  load(
    here::here(
      "data/7_24_mike/wearable_omics_correlation/hr_cgm_correlation/important_hr_cgm"
    )
  )
  load(
    here::here(
      "data/7_24_mike/wearable_omics_correlation/steps_cgm_correlation/important_step_cgm"
    )
  )
  load(
    here::here(
      "data/7_24_mike/wearable_omics_correlation/steps_hr_correlation/important_step_hr"
    )
  )
...
load(here::here("data/7_24_mike/wearable_omics_correlation/steps_hr_correlation/lagged_correlation/lagged_result"))
