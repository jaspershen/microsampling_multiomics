...
######hr vs lipidomics
dir.create("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_lipidomics")
setwd("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_lipidomics")
