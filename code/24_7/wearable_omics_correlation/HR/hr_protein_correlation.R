...
######hr vs proteomics
dir.create("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_proteomics")
setwd("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_proteomics")
