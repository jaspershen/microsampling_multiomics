...
######hr vs cytokine
dir.create("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_cytokine")
setwd("data/7_24_mike/wearable_omics_correlation/hr_omics_correlation/hr_cytokine")
