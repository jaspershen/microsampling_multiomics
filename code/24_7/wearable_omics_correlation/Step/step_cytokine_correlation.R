...
######steps vs cytokine
dir.create("data/7_24_mike/wearable_omics_correlation/steps_omics_correlation/steps_cytokine")
setwd("data/7_24_mike/wearable_omics_correlation/steps_omics_correlation/steps_cytokine")
