...
dir.create("data/7_24_mike/wearable_omics_correlation/steps_omics_correlation/steps_metabolic_panel")
setwd("data/7_24_mike/wearable_omics_correlation/steps_omics_correlation/steps_metabolic_panel")
