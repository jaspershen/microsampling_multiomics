...
library(plyr)
temp =
  temp_data_cortisol %>% plyr::dlply(.variables = .(day))
...
# ggsave(plot_cortisol1, filename = "plot_cortisol1.pdf", width = 14, height = 3)
# ggsave(plot_cortisol2, filename = "plot_cortisol2.pdf", width = 14, height = 7)
# ggsave(plot_cortisol3, filename = "plot_cortisol3.pdf", width = 14, height = 7)
