...
load("data/stability/lipidomics/data_preparation/lipidomics_data")

dir.create("data/stability/lipidomics/correlation_variables",
           recursive = TRUE)
setwd("data/stability/lipidomics/correlation_variables")
...
lm_reg <- 
lm(log(lipidomics_data@variable_info$median_intensity_m + 1, 10) ~ log(lipidomics_data@variable_info$median_intensity_p + 1, 10))
