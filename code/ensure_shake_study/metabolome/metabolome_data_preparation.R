...
masstools::setwd_project()
setwd("data/ensure_shake_study/metabolomics_data_analysis/data_preparation/")
...
openxlsx::write.xlsx(
  x = sample_info,
  file = "metabolites/sample_info.xlsx",
  asTable = TRUE,
  overwrite = TRUE
)
openxlsx::write.xlsx(
  x = variable_info,
  file = "metabolites/variable_info.xlsx",
  asTable = TRUE,
  overwrite = TRUE
)
...
openxlsx::write.xlsx(
  x = expression_data,
  file = "metabolites/expression_data.xlsx",
  asTable = TRUE,
  overwrite = TRUE
)
