...
masstools::setwd_project()
setwd("data/ensure_shake_study/3_omics/data_overview")


write.csv(variable_info1, file = "metabolomics_marker.csv", row.names = FALSE)
write.csv(variable_info2, file = "lipidomics_marker.csv", row.names = FALSE)
write.csv(variable_info3, file = "cytokine_marker.csv", row.names = FALSE)
...
temp_data =
  data.frame(
    class = c("Metabolite", "Lipid", "Cytokine"),
