...
masstools::setwd_project()
setwd("data/ensure_shake_study/lipidomics_data_analysis/k_means_clustering")
...
# ggsave(plot1, filename = "cluster1_annotation.pdf", width = 7, height = 7)
...
# ggsave(plot2, filename = "cluster2_annotation.pdf", width = 7, height = 7)
