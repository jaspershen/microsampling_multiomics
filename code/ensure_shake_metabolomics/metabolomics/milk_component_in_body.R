...
load("data/ensure_shake_study/metabolomics_data_analysis/data_preparation/peaks/expression_data")
load("data/ensure_shake_study/metabolomics_data_analysis/data_preparation/peaks/sample_info")
load("data/ensure_shake_study/metabolomics_data_analysis/data_preparation/peaks/variable_info")
...
####set work directory
masstools::setwd_project()
setwd("data/ensure_shake_study/milk_component_in_body")
