...
####load data
{
  ###
  load(here::here(
    "data/24_7_study/combine_omics/data_preparation/expression_data"
  ))
  load(here::here(
    "data/24_7_study/combine_omics/data_preparation/sample_info"
  ))
  load(here::here(
    "data/24_7_study/combine_omics/data_preparation/variable_info"
  ))
}

library(MetaCycle)

setwd("data/24_7_study/circadian_analysis/all_omics/day_consistence")
...
cor(
  consistence_score$consistence_score,
