...
setwd("data/24_7_study/combine_omics/data_preparation")
...
cor_data =
  purrr::map(
    ...
    .f = function(idx) {
      ...
      temp_data =
        data.frame(
          value1 = as.numeric(expression_data[idx, matched_idx$idx1]),
...
plot
ggsave(plot,
       filename = "real_loess_comparison_each_feature.pdf",
       height = 5,
       width = 16)
