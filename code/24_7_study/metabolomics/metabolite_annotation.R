...
setwd("data/24_7_study/metabolomics/metabolite_annotation/HILIC/POS/")
library(tidyverse)
library(data.table)
library(metID)
...
###negative mode
masstools::setwd_project()
setwd("data/24_7_study/metabolomics/metabolite_annotation/HILIC/NEG/")
library(tidyverse)
library(data.table)
library(metID)
...
###positive mode
masstools::setwd_project()
setwd("data/24_7_study/metabolomics/metabolite_annotation/RPLC/POS/")
library(tidyverse)
library(data.table)
library(metID)
...
###negative mode
masstools::setwd_project()
setwd("data/24_7_study/metabolomics/metabolite_annotation/RPLC/NEG/")
library(tidyverse)
library(data.table)
library(metID)
...
##rename
masstools::setwd_project()
setwd("data/24_7_study/metabolomics/metabolite_annotation/")
library(tidyverse)
library(data.table)
library(metID)
