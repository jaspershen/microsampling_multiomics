...
#####load food log data
{
  load(here::here("data/24_7_study/food_log/data_preparation/expression_data"))
  load(here::here("data/24_7_study/food_log/data_preparation/sample_info"))
  load(here::here("data/24_7_study/food_log/data_preparation/variable_info"))
...
setwd("data/24_7_study/cgm/cgm_vs_food")
