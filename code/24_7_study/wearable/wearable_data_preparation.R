...
setwd("data/24_7_study/sleep/data_preparation/")
load("sleep")
...
######steps
masstools::setwd_project()
setwd("data/24_7_study/steps/data_preparation/")
...
masstools::setwd_project()
setwd("data/24_7_study/hr/data_preparation")
...
masstools::setwd_project()
setwd("data/24_7_study/cgm/data_preparation/")
