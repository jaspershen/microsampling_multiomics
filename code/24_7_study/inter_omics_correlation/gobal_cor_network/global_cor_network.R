...
{
  ###lipidomics
  load("data/24_7_study/lipidomics/k_means_clustering/new_sample_info")
...
###metabolomics
{
  load("data/24_7_study/metabolomics/k_means_clustering/new_sample_info")
  load("data/24_7_study/metabolomics/k_means_clustering/new_variable_info")
  load("data/24_7_study/metabolomics/k_means_clustering/new_expression_data")
...
{
  ###proteomics
  load("data/24_7_study/proteomics/k_means_clustering/new_sample_info")
  load("data/24_7_study/proteomics/k_means_clustering/new_variable_info")
  load("data/24_7_study/proteomics/k_means_clustering/new_expression_data")
...
######
dir.create("data/24_7_study/inter_omics_correlation/global_cor_network")
setwd("data/24_7_study/inter_omics_correlation/global_cor_network")
