...
######cgm vs cytokine
###work directory
###data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_cytokine
masstools::setwd_project()
setwd("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_cytokine")
...
for(i in 1:nrow(important_cytokine)){
  ...
  ggsave(result$plot, 
         filename = 
           here::here(file.path("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_cytokine/peak_quality", name)), 
                      width = 9, height = 7)
}
...
plot = 
  ...
  #   plot,
  #   file = here::here(
  #     "data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_cytokine/cytokine_order.pdf"
  #   ),
  #   width = 8,
  #   height = 7
  # )
...
# knitr::spin(
#   hair = here::here(
#     "code/24_7_mike/wearable_omics_correlation/CGM/cgm_cytokine_correlation.R"
#   ),
#   knit = FALSE
# )
# 
# file.copy(from = here::here("code/24_7_mike/wearable_omics_correlation/CGM/cgm_cytokine_correlation.Rmd"),
