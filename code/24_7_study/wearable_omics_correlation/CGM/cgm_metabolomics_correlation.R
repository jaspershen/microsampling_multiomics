#' ---
#' title: "CGM metabolomics correlation"
#' author: 
#'   - name: "Xiaotao Shen" 
...
######cgm vs metabolomics
dir.create("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolomics")
setwd("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolomics")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between cgm and metabolomicss
#global correlation
...
# addWorksheet(wb, sheetName = "CGM metabolomics global cor",
#              gridLines = TRUE)
...
#       object = lagged_result[[temp$variable_id[i]]],
...
#     )
#   
#   name = paste("CGM vs", temp$Compound.name[i])
#   ggsave(
#     plot1,
...
#   
#   name =
#     metabolomics_variable_info$Compound.name[match(names(lagged_result)[i],
#                                                    metabolomics_variable_info$variable_id)]
#   
#   name =
#     name %>%
...
# kegg_result_pos = 
#   enrich_kegg(query_id = important_metabolite_pos$KEGG.ID, 
#               query_type = "compound", 
#               id_type = "KEGG",
...
#####remove redundancy pathways
remain_idx_pos = 
  which(kegg_result_pos@result$p_value_adjust <
  kegg_result_neg@result$p_value_adjust)
...
kegg_result_pos@result = kegg_result_pos@result[remain_idx_pos,]
kegg_result_neg@result = kegg_result_neg@result[remain_idx_neg,]
