...
######cgm vs lipidomics
dir.create("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_lipidomics")
setwd("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_lipidomics")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between cgm and lipidomicss
#global correlation
...
# addWorksheet(wb, sheetName = "CGM lipidomics global cor",
#              gridLines = TRUE)
...
pos_enriched = readr::read_delim("lipidminion/positive/Fisher output table (6 pvals _ 0.05).txt", delim = " ")
...
neg_enriched = readr::read_delim("lipidminion/negative/Fisher output table (3 pvals _ 0.05).txt", delim = " ")
...
pos_enriched$Classifier[1] = "Free facty acid"
pos_enriched$Classifier[3] = "FFA"
pos_enriched$Classifier[5] = "FFA("
