...
######cgm vs metabolic_panel
dir.create("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolic_panel")
setwd("data/24_7_study/wearable_omics_correlation/cgm_omics_correlation/cgm_metabolic_panel")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between cgm and metabolic_panels
#global correlation
...
addWorksheet(wb, sheetName = "CGM metabolic_panel global cor",
             gridLines = TRUE)
...
for(i in 1:nrow(important_metabolic_panel)){
  ...
  name =
    important_metabolic_panel$mol_name[i]
