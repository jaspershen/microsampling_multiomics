...

{
  ####load data
  ###CGM
  load("data/24_7/cgm/data_preparation/sample_info")
  load("data/24_7/cgm/data_preparation/variable_info")
  load("data/24_7/cgm/data_preparation/expression_data")
  ...
  ###proteomics
  load("data/24_7/proteomics/data_preparation/sample_info")
  load("data/24_7/proteomics/data_preparation/variable_info")
  load("data/24_7/proteomics/data_preparation/expression_data")
...
######cgm vs proteomics
masstools::setwd_project()
dir.create("data/24_7/wearable_omics_correlation/cgm_omics_correlation/cgm_proteomics",
           showWarnings = FALSE)
setwd("data/24_7/wearable_omics_correlation/cgm_omics_correlation/cgm_proteomics")
