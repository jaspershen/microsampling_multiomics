...
######hr vs total_protein
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_total_protein")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_total_protein")
