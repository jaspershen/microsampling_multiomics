...
######hr vs metabolic_panel
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_metabolic_panel")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_metabolic_panel")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between hr and metabolic_panels
#global correlation
...
# addWorksheet(wb, sheetName = "HR metabolic_panel global cor",
#              gridLines = TRUE)
