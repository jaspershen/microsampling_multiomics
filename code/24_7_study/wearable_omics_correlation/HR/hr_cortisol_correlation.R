...
######hr vs cortisol
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_cortisol")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_cortisol")
