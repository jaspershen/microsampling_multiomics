...
######hr vs cytokine
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_cytokine")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_cytokine")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between hr and cytokines
#global correlation
...
# addWorksheet(wb, sheetName = "HR cytokine global cor",
#              gridLines = TRUE)
