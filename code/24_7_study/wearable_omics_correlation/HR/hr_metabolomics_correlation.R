...
######hr vs metabolomics
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_metabolomics")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_metabolomics")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between hr and metabolomicss
#global correlation
...
# addWorksheet(wb, sheetName = "HR metabolomics global cor",
#              gridLines = TRUE)
...
#                           integrated = TRUE)
# 
#   name = paste("HR vs",temp$Compound.name[i])
#   ggsave(plot1,
