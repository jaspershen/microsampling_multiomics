...
######hr vs lipidomics
dir.create("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_lipidomics")
setwd("data/24_7_study/wearable_omics_correlation/hr_omics_correlation/hr_lipidomics")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between hr and lipidomicss
#global correlation
...
# addWorksheet(wb, sheetName = "HR lipidomics global cor",
#              gridLines = TRUE)
...
###here we used the lipidomicsminion tool
###out the positive lipidomicss
plot =
  cor_data %>%
...
pos_enriched = readr::read_delim("lipidminion/positive/Fisher output table (5 pvals _ 0.05).txt", delim = " ")
...
neg_enriched = readr::read_delim("lipidminion/negative/Fisher output table (6 pvals _ 0.05).txt", delim = " ")
...
pos_enriched$Classifier[2] = "Free facty acid"
pos_enriched$Classifier[4] = "FFA"
