...
######hr vs heart rate
dir.create("data/24_7_study/wearable_omics_correlation/hr_cgm_correlation")
setwd("data/24_7_study/wearable_omics_correlation/hr_cgm_correlation")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between hr and cgms
#global correlation
...
#   cat(i, " ")
#   y = as.numeric(hr_expression_data[i, ])
...
# addWorksheet(wb, sheetName = "HR cgm global cor",
#              gridLines = TRUE)
...
save(important_hr_cgm, file = "important_hr_cgm")
