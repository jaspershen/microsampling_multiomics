...
######steps vs proteomics
dir.create("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_proteomics")
setwd("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_proteomics")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between steps and proteomicss
#global correlation
...
# addWorksheet(wb, sheetName = "Step proteomics global cor",
#              gridLines = TRUE)
...
###here we only use the protein with p < 0.05, we don't filter with cor
important_protein = 
  important_protein %>% 
