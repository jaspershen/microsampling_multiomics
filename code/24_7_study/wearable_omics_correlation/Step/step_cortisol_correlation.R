...
######steps vs cortisol
dir.create("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_cortisol")
setwd("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_cortisol")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between steps and cortisols
#global correlation
...
####which time window
temp_data = 
data.frame(time = steps_sample_info$accurate_time,
...
# integrated_info = 
# purrr::map(.x = c(300, 360, 420, 480, 540, 600), function(x){
#   ###x is second
#   time_seq= 
...
load("integrated_info")

integrated_info[[6]]$mean %>% plot()
integrated_info[[6]]$sd %>% plot()

###so here we set the windows as 300 second (5 minutes)
...
# addWorksheet(wb, sheetName = "Step cortisol global cor",
#              gridLines = TRUE)
