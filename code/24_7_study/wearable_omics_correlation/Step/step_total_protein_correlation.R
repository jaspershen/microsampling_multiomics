...
######steps vs total_protein
dir.create("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_total_protein")
setwd("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_total_protein")

#####---------------------------------------------------------------------------
#####---------------------------------------------------------------------------
###correlation between steps and total_proteins
#global correlation
...
# addWorksheet(wb, sheetName = "Step total_protein global cor",
#              gridLines = TRUE)
