...
######steps vs lipidomics
dir.create("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_lipidomics")
setwd("data/24_7_study/wearable_omics_correlation/steps_omics_correlation/steps_lipidomics")
