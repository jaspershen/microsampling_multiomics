...
######sleep vs omics
dir.create("data/24_7_study/sleep/sleep_omics")
setwd("data/24_7_study/sleep/sleep_omics")
...
load(here::here("data/24_7_study/metabolomics/orbitrapDatabase0.0.1"))

which(metabolomics_variable_info_raw$variable_id == variable_info[1116,]$variable_id)

metabolomics_variable_info_raw[388,]

load(here::here("data/24_7_study/metabolomics/metabolite_annotation/HILIC/POS/NCE25/result_hilic_pos25"))
load(here::here("data/24_7_study/metabolomics/metabolite_annotation/HILIC/POS/NCE35/result_hilic_pos35"))
