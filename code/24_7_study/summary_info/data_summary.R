...

{
  ...
  ##sleep
  load("data/24_7_study/sleep/data_preparation/sample_info")
  load("data/24_7_study/sleep/data_preparation/variable_info")
  load("data/24_7_study/sleep/data_preparation/expression_data")
...
###internal omics data
{
  ...
  ###food_log
  load("data/24_7_study/food_log/data_preparation/sample_info")
  load("data/24_7_study/food_log/data_preparation/variable_info")
  load("data/24_7_study/food_log/data_preparation/expression_data")
  ...
  load("data/24_7_study/metabolomics/data_preparation/peaks/sample_info")
  load("data/24_7_study/metabolomics/data_preparation/peaks/variable_info")
  load("data/24_7_study/metabolomics/data_preparation/peaks/expression_data")
...
###set work directory
setwd("data/24_7_study/summary_info")
...
##food
temp_data_food = 
  masstools::convert2long(expression_data = food_expression_data, 
