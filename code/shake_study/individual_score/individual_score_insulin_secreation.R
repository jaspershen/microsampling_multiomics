...
#   })
# 
# names(inslulin_secreation_score) = unique(sample_info$subject_id)
# 
# inslulin_secreation_score =
#   inslulin_secreation_score %>%
#   do.call(rbind, .) %>%
#   as.data.frame()
# 
# save(inslulin_secreation_score, file = "inslulin_secreation_score")
load("inslulin_secreation_score")
...
plot
# ggsave(plot, filename = "inslulin_secreation_score_plot.pdf", width = 10, height = 7)
