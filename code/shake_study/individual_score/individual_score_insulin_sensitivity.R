...
masstools::setwd_project()
setwd("data/shake_study/3_omics/individual_scores/inslulin_sensitivity_score/")
...
plot
# ggsave(plot, filename = "inslulin_sensitivity_plot.pdf", width = 7, height = 7)
...
plot
# ggsave(plot, filename = "inslulin_sensitivity_plot2.pdf", width = 14, height = 8)

# inslulin_sensitivity_score =
...
#   })
#
# names(inslulin_sensitivity_score) = unique(sample_info$subject_id)
# inslulin_sensitivity_score =
#   inslulin_sensitivity_score %>%
#   do.call(rbind, .) %>%
#   as.data.frame()
#
# save(inslulin_sensitivity_score, file = "inslulin_sensitivity_score")
load("inslulin_sensitivity_score")
...
plot
# ggsave(plot, filename = "inslulin_sensitivity_score_plot.pdf", width = 10, height = 7)
...
ggsave(plot, filename = "inslulin_sensitivity_score_boxplot.pdf", width = 14, height = 3)
