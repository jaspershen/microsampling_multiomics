...
sxtTools::setwd_project()
setwd("data/shake_study/lipidomics_data_analysis/invidual_variation")
...
ggsave(plot, filename = "lipidomics_inter_vist_distance.pdf", width = 9, height = 7)
