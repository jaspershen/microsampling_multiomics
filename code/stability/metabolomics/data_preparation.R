...
setwd("data/stability/metabolomics/")
rm(list = ls())
library(tidyverse)

data <- readr::read_csv("Ryan_mitra_plasma_metabolomics_all_Anno (1).csv")
...
masstools::setwd_project()
setwd("data/stability/metabolomics/data_preparation")
...
sample_info <- extract_expression_data(metabolomics_data)
variable_info <- extract_expression_data(metabolomics_data)
